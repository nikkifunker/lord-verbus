...
async def cmd_lord_psych(m: Message, command: CommandObject):
    ...
    user = (
        ...
        "\n\n"
        "Сгенерируй ответ строго в виде трёх HTML-абзацев, каждый отделён <br><br>.\n"
        "Первый абзац — вводное описание и характер человека.\n"
        "Второй — анализ его речи, поведения, мотивов и противоречий, с 2–3 встроенными цитатами со ссылками.\n"
        "Третий — краткий саркастичный вердикт с финальной оценкой в духе Лорда Вербуса."
    )
